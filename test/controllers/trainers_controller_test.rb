...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { email: @trainer.email, name: @trainer.name, password_digest: @trainer.password_digest } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { email: @trainer.email, name: @trainer.name, password_digest: @trainer.password_digest } }
